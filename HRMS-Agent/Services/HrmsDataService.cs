...
public class HrmsDataService
{
    ...
    public List<EmployeeSummary> GetAllEmployees(string? department = null, string? status = null, string? salary = null)
    {
        ...
        if (!string.IsNullOrWhiteSpace(salary) && decimal.TryParse(salary, out var salaryValue))
            query = query.Where(e => e.Salary >= salaryValue);
    ...
    public List<AttendanceRecord> GetAttendanceRecords(int? employeeId = null,int? AttendanceId = null, string? date = null, string? status = null)
    {
        ...
        if (AttendanceId.HasValue)
            query = query.Where(a => a.EmployeeId == AttendanceId.Value);
    ...
    public AttendanceRecord? MarkAttendance(AttendanceCreateDto request)
    {
    ...
    private static List<AttendanceRecord> SeedAttendance() => new()
    {
        ...
        new AttendanceRecord
        {
            ...
            CheckInTime = "08:55",
            CheckOutTime = "18:15",
            Notes = "Engineering team review meeting"
        },
        new AttendanceRecord
        {
            AttendanceId = 3,
            ...
            CheckInTime = "09:10",
            CheckOutTime = "17:50",
            Notes = "Employee onboarding session"
        },
        new AttendanceRecord
        {
            AttendanceId = 4,
            EmployeeId = 4,
            EmployeeName = "Mohammed Farhan",
            Date = "2026-06-08",
            Status = "Present",
            CheckInTime = "09:00",
            CheckOutTime = "18:05",
            Notes = "Monthly financial analysis"
        },
        new AttendanceRecord
        {
            AttendanceId = 5,
        ...
        new AttendanceRecord
        {
            ...
            CheckInTime = "08:45",
            CheckOutTime = "19:00",
            Notes = "Technology strategy discussion"
        },
        new AttendanceRecord
        {
            AttendanceId = 7,
            EmployeeId = 7,
            EmployeeName = "Anita George",
            Date = "2026-06-08",
            Status = "Present",
            CheckInTime = "09:05",
            CheckOutTime = "17:55",
            Notes = "Operations planning and coordination"
        },
        new AttendanceRecord
        {
            AttendanceId = 8,
        ...
        new AttendanceRecord
        {
            ...
            CheckInTime = "08:50",
            CheckOutTime = "18:00",
            Notes = "HR policy review"
        },
        new AttendanceRecord
        {
            AttendanceId = 10,
            EmployeeId = 10,
            EmployeeName = "Arun Chandran",
            Date = "2026-06-08",
            Status = "Present",
            CheckInTime = "09:00",
            CheckOutTime = "18:20",
            Notes = "Quarterly financial reporting"
        }
    };
